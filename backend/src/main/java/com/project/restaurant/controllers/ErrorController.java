...
import com.project.restaurant.domain.dtos.ErrorDto;
import com.project.restaurant.exceptions.BaseException;
...
import com.project.restaurant.exceptions.StorageException;
...
public class ErrorController {
    ...
    public ResponseEntity<ErrorDto> handleBaseException(BaseException ex) {
        log.error("Caught BaseException exception", ex);
    ...
    public ResponseEntity<ErrorDto> handleRestaurantNotFoundException(RestaurantNotFoundException ex) {
        log.error("Caught RestaurantNotFoundException exception", ex);
    ...
    public ResponseEntity<ErrorDto> handleReviewNotFoundException(ReviewNotAllowedException ex) {
        log.error("Caught ReviewNotAllowedException exception", ex);

        ErrorDto error = ErrorDto.builder()
                .status(HttpStatus.BAD_REQUEST.value())
                .message("The specified review cannot be created or added")
                .build();
